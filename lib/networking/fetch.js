...
function fetch(options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (fetchResponse.status >= 300 &&
            ...
            return fetch(Object.assign(Object.assign({}, options), { url: fetchResponse.headers['location'] }));
        }
        ...
        if (fetchResponse.status >= 400 ||
            ...
            if (reauthenticationNeeded && fetchOptions.auth) {
                ...
                return fetch(Object.assign(Object.assign({}, options), { numRetries: numRetries + 1, fileStream: fileStreamBuffer
                        ? (0, utils_1.generateByteStreamFromBuffer)(fileStreamBuffer)
                        : void 0 }));
            }
            ...
            if (isRetryable && numRetries < DEFAULT_MAX_ATTEMPTS) {
                ...
                return fetch(Object.assign(Object.assign({}, options), { numRetries: numRetries + 1 }));
            }
