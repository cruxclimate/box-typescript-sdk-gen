...
function serializeAiExtract(val) {
    return {
        ...
        ['ai_agent']: val.aiAgent == void 0
            ? val.aiAgent
            : (0, aiAgentExtract_generated_js_1.serializeAiAgentExtract)(val.aiAgent),
    };
}
function deserializeAiExtract(val) {
    ...
    const items = (0, json_js_2.sdIsList)(val.items)
        ...
        : [];
    const aiAgent = val.ai_agent == void 0 ? void 0 : (0, aiAgentExtract_generated_js_2.deserializeAiAgentExtract)(val.ai_agent);
