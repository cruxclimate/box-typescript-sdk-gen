...
function serializeAiExtractStructured(val) {
    return {
        ...
        ['ai_agent']: val.aiAgent == void 0
            ? val.aiAgent
            : (0, aiAgentExtractStructured_generated_js_1.serializeAiAgentExtractStructured)(val.aiAgent),
    };
}
function deserializeAiExtractStructured(val) {
    ...
    const aiAgent = val.ai_agent == void 0
        ? void 0
        : (0, aiAgentExtractStructured_generated_js_2.deserializeAiAgentExtractStructured)(val.ai_agent);
    return {
        items: items,
