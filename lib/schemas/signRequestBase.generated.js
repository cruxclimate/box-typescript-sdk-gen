...
function serializeSignRequestBase(val) {
    return {
        ...
        ['is_phone_verification_required_to_view']: val.isPhoneVerificationRequiredToView,
...
function deserializeSignRequestBase(val) {
    ...
    if (!(val.is_phone_verification_required_to_view == void 0) &&
        !(0, json_js_1.sdIsBoolean)(val.is_phone_verification_required_to_view)) {
        throw new errors_js_1.BoxSdkError({
            message: 'Expecting boolean for "is_phone_verification_required_to_view" of type "SignRequestBase"',
        });
    }
