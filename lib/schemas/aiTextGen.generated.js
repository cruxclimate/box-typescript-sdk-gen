...
function serializeAiTextGen(val) {
    return {
        ...
        ['ai_agent']: val.aiAgent == void 0
            ? val.aiAgent
            : (0, aiAgentTextGen_generated_js_1.serializeAiAgentTextGen)(val.aiAgent),
    };
}
function deserializeAiTextGen(val) {
    ...
    const dialogueHistory = val.dialogue_history == void 0
        ...
        : (0, json_js_2.sdIsList)(val.dialogue_history)
            ...
            : [];
    const aiAgent = val.ai_agent == void 0 ? void 0 : (0, aiAgentTextGen_generated_js_2.deserializeAiAgentTextGen)(val.ai_agent);
    return {
        prompt: prompt,
        items: items,
