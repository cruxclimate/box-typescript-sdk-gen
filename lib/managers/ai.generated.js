...
const aiExtractResponse_generated_js_1 = require("../schemas/aiExtractResponse.generated.js");
...
class AiManager {
    ...
    createAiExtractStructured(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, aiExtractResponse_generated_js_1.deserializeAiExtractResponse)(response.data)), { rawData: response.data });
        });
    }
}
