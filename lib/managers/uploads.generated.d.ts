...
export declare class UploadsManager {
    ...
    constructor(fields: Omit<UploadsManager, 'networkSession' | 'uploadFileVersion' | 'preflightFileUploadCheck' | 'uploadFile'> & Partial<Pick<UploadsManager, 'networkSession'>>);
    /**
