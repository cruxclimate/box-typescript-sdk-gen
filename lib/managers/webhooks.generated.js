...
class WebhooksManager {
    ...
    static validateMessage(body_1, headers_1, primaryKey_1) {
        return __awaiter(this, arguments, void 0, function* (body, headers, primaryKey, optionalsInput = {}) {
            ...
            const deliveryTimestamp = (0, utils_js_4.dateTimeFromString)(headers['box-delivery-timestamp']);
            const currentEpoch = (0, utils_js_5.getEpochTimeInSeconds)();
            if (currentEpoch - maxAge > (0, utils_js_6.dateTimeToEpochSeconds)(deliveryTimestamp) ||
                (0, utils_js_6.dateTimeToEpochSeconds)(deliveryTimestamp) > currentEpoch) {
                return false;
            }
            if (primaryKey &&
                (yield (0, utils_js_3.computeWebhookSignature)(body, headers, primaryKey)) ==
                    headers['box-signature-primary']) {
                return true;
            }
            if (secondaryKey &&
                (yield (0, utils_js_3.computeWebhookSignature)(body, headers, secondaryKey)) ==
