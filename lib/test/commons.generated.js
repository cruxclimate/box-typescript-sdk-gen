...
function getDefaultClient() {
    const client = new client_generated_js_1.BoxClient({ auth: getJwtAuth() });
    return client;
}
...
function getOrCreateTermsOfServices() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (numberOfTos >= 1) {
            ...
            if ((0, utils_js_5.toString)(firstTos.tosType) == 'managed') {
                return firstTos;
            }
        }
        if (numberOfTos >= 2) {
            const secondTos = tos.entries[1];
            if ((0, utils_js_5.toString)(secondTos.tosType) == 'managed') {
                return secondTos;
            }
        }
