...
test('testWebhooksCRUD', function testWebhooksCRUD() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!((0, utils_js_6.toString)(webhook.target.type) == 'folder')) {
            throw new Error('Assertion failed');
        }
...
test('testWebhookValidation', function testWebhookValidation() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const headersWithCorrectDatetime = Object.assign(Object.assign({}, headers), {
            ...
            ['box-signature-primary']: yield (0, utils_js_5.computeWebhookSignature)(body, Object.assign(Object.assign({}, headers), { ['box-delivery-timestamp']: currentDatetime }), primaryKey),
            ['box-signature-secondary']: yield (0, utils_js_5.computeWebhookSignature)(body, Object.assign(Object.assign({}, headers), { ['box-delivery-timestamp']: currentDatetime }), secondaryKey),
        });
        const headersWithJapaneseWithCorrectDatetime = Object.assign(Object.assign({}, headersWithJapanese), {
            ['box-delivery-timestamp']: currentDatetime,
            ['box-signature-primary']: yield (0, utils_js_5.computeWebhookSignature)(bodyWithJapanese, Object.assign(Object.assign({}, headersWithJapanese), { ['box-delivery-timestamp']: currentDatetime }), primaryKey),
            ['box-signature-secondary']: yield (0, utils_js_5.computeWebhookSignature)(bodyWithJapanese, Object.assign(Object.assign({}, headersWithJapanese), { ['box-delivery-timestamp']: currentDatetime }), secondaryKey),
        });
        const headersWithFutureDatetime = Object.assign(Object.assign({}, headers), {
            ['box-delivery-timestamp']: futureDatetime,
            ['box-signature-primary']: yield (0, utils_js_5.computeWebhookSignature)(body, Object.assign(Object.assign({}, headers), { ['box-delivery-timestamp']: futureDatetime }), primaryKey),
            ['box-signature-secondary']: yield (0, utils_js_5.computeWebhookSignature)(body, Object.assign(Object.assign({}, headers), { ['box-delivery-timestamp']: futureDatetime }), secondaryKey),
        });
        const headersWithPastDatetime = Object.assign(Object.assign({}, headers), {
            ['box-delivery-timestamp']: pastDatetime,
            ['box-signature-primary']: yield (0, utils_js_5.computeWebhookSignature)(body, Object.assign(Object.assign({}, headers), { ['box-delivery-timestamp']: pastDatetime }), primaryKey),
            ['box-signature-secondary']: yield (0, utils_js_5.computeWebhookSignature)(body, Object.assign(Object.assign({}, headers), { ['box-delivery-timestamp']: pastDatetime }), secondaryKey),
        });
        ...
        if (!((yield (0, utils_js_5.computeWebhookSignature)(body, headers, primaryKey)) ==
            headers['box-signature-primary'])) {
            throw new Error('Assertion failed');
        }
        if (!((yield (0, utils_js_5.computeWebhookSignature)(body, headers, secondaryKey)) ==
            headers['box-signature-secondary'])) {
            throw new Error('Assertion failed');
        }
        if (!!((yield (0, utils_js_5.computeWebhookSignature)(body, headers, incorrectKey)) ==
            headers['box-signature-primary'])) {
            throw new Error('Assertion failed');
        }
        if (!((yield (0, utils_js_5.computeWebhookSignature)(bodyWithJapanese, headersWithJapanese, primaryKey)) == headersWithJapanese['box-signature-primary'])) {
            throw new Error('Assertion failed');
        }
        if (!((yield (0, utils_js_5.computeWebhookSignature)(bodyWithEmoji, headersWithEmoji, primaryKey)) == headersWithEmoji['box-signature-primary'])) {
            throw new Error('Assertion failed');
        }
        if (!((yield (0, utils_js_5.computeWebhookSignature)(bodyWithCarriageReturn, headersWithCarriageReturn, primaryKey)) == headersWithCarriageReturn['box-signature-primary'])) {
            throw new Error('Assertion failed');
        }
        ...
        if (!((yield webhooks_generated_js_1.WebhooksManager.validateMessage(body, headersWithCorrectDatetime, incorrectKey, { secondaryKey: incorrectKey })) == false)) {
            throw new Error('Assertion failed');
        }
        if (!((yield webhooks_generated_js_1.WebhooksManager.validateMessage(body, headersWithFutureDatetime, primaryKey, { secondaryKey: secondaryKey })) == false)) {
            throw new Error('Assertion failed');
        }
        if (!((yield webhooks_generated_js_1.WebhooksManager.validateMessage(body, headersWithPastDatetime, primaryKey, { secondaryKey: secondaryKey })) == false)) {
            throw new Error('Assertion failed');
        }
        if (!((yield webhooks_generated_js_1.WebhooksManager.validateMessage(body, headersWithWrongSignatureVersion, primaryKey, { secondaryKey: secondaryKey })) == false)) {
            throw new Error('Assertion failed');
        }
        if (!((yield webhooks_generated_js_1.WebhooksManager.validateMessage(body, headersWithWrongSignatureAlgorithm, primaryKey, { secondaryKey: secondaryKey })) == false)) {
            throw new Error('Assertion failed');
        }
        ...
        if (!((yield webhooks_generated_js_1.WebhooksManager.validateMessage(bodyWithJapanese, headersWithJapanese, primaryKey, { secondaryKey: secondaryKey })) == false)) {
            throw new Error('Assertion failed');
        }
    });
});
