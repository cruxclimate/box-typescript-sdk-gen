...
test('test_get_user_me', function test_get_user_me() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!((0, utils_js_3.toString)(currentUser.type) == 'user')) {
            throw new Error('Assertion failed');
        }
    });
});
...
test('test_user_notification_email', function test_user_notification_email() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const updatedWithNotificationEmail = yield exports.client.users.updateUserById(user.id, {
            requestBody: {
                notificationEmail: {
                    email: userLogin,
                },
        ...
        const updatedWithoutNotificationEmail = yield exports.client.users.updateUserById(user.id, {
            requestBody: {
                notificationEmail: (0, utils_js_2.createNull)(),
            },
        });
